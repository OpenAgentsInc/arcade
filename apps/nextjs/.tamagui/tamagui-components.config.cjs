...
var require_compose_refs = __commonJS({
  "../../node_modules/@tamagui/compose-refs/dist/cjs/compose-refs.js"(exports, module2) {
    ...
    function useComposedRefs4(...refs) {
      return React43.useCallback(composeRefs4(...refs), refs);
    }
...
var require_useGet = __commonJS({
  "../../node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var isWeb30 = process.env.TAMAGUI_TARGET === "web";
    var isClient6 = typeof window !== "undefined";
    var useIsomorphicLayoutEffect15 = !isWeb30 || isClient6 ? import_react37.useLayoutEffect : import_react37.useEffect;
    function useGet6(currentValue, initialValue2, forwardToFunction) {
      const curRef = (0, import_react37.useRef)(initialValue2 ?? currentValue);
...
var require_FocusScope = __commonJS({
  "../../node_modules/@tamagui/focus-scope/dist/cjs/FocusScope.js"(exports, module2) {
    ...
    var import_compose_refs16 = require_cjs2();
    ...
    var FocusScope4 = React43.forwardRef(
      (props, forwardedRef) => {
        ...
        const composedRefs = (0, import_compose_refs16.useComposedRefs)(forwardedRef, (node) => setContainer(node));
        ...
        const child = React43.Children.only(children);
...
var require_cjs5 = __commonJS({
  "../../node_modules/@tamagui/get-size/dist/cjs/index.js"(exports, module2) {
    ...
    __export2(src_exports, {
      getSize: () => getSize7,
      stepTokenUpOrDown: () => stepTokenUpOrDown5
    });
    module2.exports = __toCommonJS2(src_exports);
    var import_core56 = require("@tamagui/core-node");
    var getSize7 = /* @__PURE__ */ __name((size2, shift2 = 0, bounds = [0]) => {
      return stepTokenUpOrDown5("size", size2, shift2, bounds);
    }, "getSize");
    var stepTokenUpOrDown5 = /* @__PURE__ */ __name((type, name = "$true", shift2 = 0, bounds = [0]) => {
      const tokens = (0, import_core56.getTokens)({ prefixed: true })[type];
      const maybeTokenizedKeysOrdered = import_core56.tokensKeysOrdered.get(tokens) || Object.keys(tokens);
...
var require_cjs6 = __commonJS({
  "../../node_modules/@tamagui/get-button-sized/dist/cjs/index.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_get_size10 = require_cjs5();
    var getButtonSized6 = /* @__PURE__ */ __name((val, { tokens }) => {
      ...
      const ySize = (0, import_get_size10.getSize)(val, 0);
      const xSize = (0, import_get_size10.stepTokenUpOrDown)("space", val);
...
var require_component = __commonJS({
  "../../node_modules/react-style-singleton/dist/es5/component.js"(exports) {
    ...
    var styleSingleton = /* @__PURE__ */ __name(function() {
      ...
      var Sheet3 = /* @__PURE__ */ __name(function(_a) {
...
var require_cjs7 = __commonJS({
  "../../node_modules/@tamagui/get-font-sized/dist/cjs/index.js"(exports, module2) {
    ...
    var getFontSized4 = /* @__PURE__ */ __name((sizeTokenIn = "$true", { fonts, props }) => {
      var _a, _b, _c;
      const family = (0, import_core56.getVariableValue)(props.fontFamily) || "$body";
    ...
    function getDefaultSizeToken(font) {
      ...
      const sizeTokens = "$true" in font.size ? font.size : (0, import_core56.getTokens)().size;
...
var require_Image = __commonJS({
  "../../node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    (0, import_core56.setupReactNative)({
    ...
    var Image2 = StyledImage.extractable(
      (0, import_react37.forwardRef)((inProps, ref) => {
        const props = (0, import_core56.useMediaPropsActive)(inProps);
        const { src, ...rest } = props;
        const source = typeof src === "string" ? { uri: src, ...import_core56.isWeb && { width: props.width, height: props.height } } : src;
        return /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(StyledImage, { ref, source, ...rest });
      })
    );
...
var require_getFontSize = __commonJS({
  "../../node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var import_core56 = require("@tamagui/core-node");
    var getFontSize3 = /* @__PURE__ */ __name((inSize, opts) => {
      const res = getFontSizeVariable(inSize, opts);
      if ((0, import_core56.isVariable)(res)) {
        return +res.val;
      }
      return res ? +res : 16;
    }, "getFontSize");
    var getFontSizeVariable = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      const conf = (0, import_core56.getConfig)();
...
var require_getSpace = __commonJS({
  "../../node_modules/@tamagui/helpers-tamagui/dist/cjs/getSpace.js"(exports, module2) {
    ...
    var getSpace = /* @__PURE__ */ __name((token, sizeUpOrDownBy = 0) => {
      const spaces = (0, import_core56.getTokens)().space;
...
var require_useCurrentColor = __commonJS({
  "../../node_modules/@tamagui/helpers-tamagui/dist/cjs/useCurrentColor.js"(exports, module2) {
    ...
    var useCurrentColor = /* @__PURE__ */ __name((colorProp) => {
      ...
      return (0, import_core56.variableToString)(theme[colorProp] || colorProp || theme.color);
    }, "useCurrentColor");
  }
});
...
var require_useGetThemedIcon = __commonJS({
  "../../node_modules/@tamagui/helpers-tamagui/dist/cjs/useGetThemedIcon.js"(exports, module2) {
    ...
    __export2(useGetThemedIcon_exports, {
      useGetThemedIcon: () => useGetThemedIcon3
    });
    module2.exports = __toCommonJS2(useGetThemedIcon_exports);
    var import_react37 = require("react");
    var import_useCurrentColor = require_useCurrentColor();
    var useGetThemedIcon3 = /* @__PURE__ */ __name((props) => {
      const color = (0, import_useCurrentColor.useCurrentColor)(props.color);
      return (el) => {
        if (!el)
          return el;
        if ((0, import_react37.isValidElement)(el)) {
          return (0, import_react37.cloneElement)(el, {
            ...props,
            ...el.props
          });
        }
        return (0, import_react37.createElement)(el, props);
      };
    }, "useGetThemedIcon");
  }
});
...
var require_create_context = __commonJS({
  "../../node_modules/@tamagui/create-context/dist/cjs/create-context.js"(exports, module2) {
    ...
    __export2(create_context_exports, {
      createContext: () => createContext12,
      createContextScope: () => createContextScope2
    });
    module2.exports = __toCommonJS2(create_context_exports);
    var import_jsx_runtime49 = require("react/jsx-runtime");
    var React43 = __toESM2(require("react"));
    function createContext12(rootComponentName, defaultContext) {
      const Context = React43.createContext(defaultContext);
      ...
      function useContext12(consumerName) {
      ...
      __name(useContext12, "useContext");
      Provider.displayName = `${rootComponentName}Provider`;
      return [Provider, useContext12];
    }
    __name(createContext12, "createContext");
    function createContextScope2(scopeName, createContextScopeDeps = []) {
      ...
      function createContext22(rootComponentName, defaultContext) {
        ...
        __name(Provider, "Provider");
        function useContext12(consumerName, scope, options) {
          const Context = (scope == null ? void 0 : scope[scopeName][index3]) || BaseContext;
          const context = React43.useContext(Context);
          if (context)
            return context;
...
var require_getElevation = __commonJS({
  "../../node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size2, extras) => {
      ...
      const sizeNum = (0, import_core56.isVariable)(token) ? +token.val : size2;
...
var require_useControllableState = __commonJS({
  "../../node_modules/@tamagui/use-controllable-state/dist/cjs/useControllableState.js"(exports, module2) {
    ...
    function useControllableState2({
      ...
      const [state, setState] = (0, import_react37.useState)(prop ?? defaultProp);
      const previous = (0, import_react37.useRef)(state);
      const propWins = strategy === "prop-wins" && prop !== void 0;
      const value = propWins ? prop : state;
      const onChangeCb = (0, import_use_event3.useEvent)(onChange || idFn5);
      const transitionFn = transition ? import_react37.startTransition : emptyCallbackFn2;
  ...
  "../../node_modules/performant-array-to-tree/build/arrayToTree.min.js"(exports) {
    ...
    function arrayToTree(c, e) {
      ...
      for (var r, t = __assign(__assign({}, defaultConfig), e), n = [], o = {}, a = t.throwIfOrphans ? /* @__PURE__ */ new Set() : null, s = 0, h = c; s < h.length; s++) {
        ...
        Object.prototype.hasOwnProperty.call(o, d) || (o[d] = ((r = {})[t.childrenField] = [], r)), a && a.delete(d), t.dataField ? o[d][t.dataField] = i : t.assign ? o[d] = Object.assign(i, ((r = {})[t.childrenField] = o[d][t.childrenField], r)) : o[d] = __assign(__assign({}, i), ((i = {})[t.childrenField] = o[d][t.childrenField], i));
        i = o[d];
...
var require_vanilla = __commonJS({
  "../../node_modules/zustand/vanilla.js"(exports, module2) {
    "use strict";
    var createStoreImpl = /* @__PURE__ */ __name(function createStoreImpl2(createState) {
      ...
      var getState6 = /* @__PURE__ */ __name(function getState7() {
        return state;
      }, "getState");
    ...
    var createStore = /* @__PURE__ */ __name(function createStore2(createState) {
    ...
    module2.exports = vanilla;
    module2.exports.createStore = createStore;
  ...
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState30 = React43.useState, useEffect32 = React43.useEffect, useLayoutEffect5 = React43.useLayoutEffect, useDebugValue = React43.useDebugValue;
  ...
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useRef31 = React43.useRef, useEffect32 = React43.useEffect, useMemo16 = React43.useMemo, useDebugValue = React43.useDebugValue;
        function useSyncExternalStoreWithSelector(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
          ...
          var _useMemo = useMemo16(function() {
            var hasMemo = false;
...
var require_zustand = __commonJS({
  "../../node_modules/zustand/index.js"(exports, module2) {
    "use strict";
    ...
    var createImpl = /* @__PURE__ */ __name(function createImpl2(createState) {
    ...
    var create = /* @__PURE__ */ __name(function create2(createState) {
      return createState ? createImpl(createState) : createImpl;
    }, "create");
    var react = /* @__PURE__ */ __name(function(createState) {
      if (process.env.NODE_ENV !== "production") {
    ...
    module2.exports.useStore = useStore;
    module2.exports.createStore = vanilla.createStore;
    exports.default = module2.exports;
  }
});
...
var require_dist3 = __commonJS({
  "../../node_modules/reforest/dist/index.js"(exports, module2) {
    ...
    var React43 = __toESM2(require("react"));
    var PrerenderContext = React43.createContext(false);
    ...
    var TreeStateContext = React43.createContext(null);
    ...
    var useIsomorphicLayoutEffect15 = isServer3 ? React210.useEffect : React210.useLayoutEffect;
    ...
    function useRovingIndex({
      ...
      const [activeIndex, setLocalActiveIndex] = React44.useState(defaultIndex);
      const getNextIndex = React44.useCallback(
        (nextIndex) => {
          if (wrap) {
      ...
      const moveActiveIndex = React44.useCallback(
        (amountToMove) => {
          setLocalActiveIndex((currentIndex) => getNextIndex(currentIndex + amountToMove));
        },
        [getNextIndex]
      );
      const setActiveIndex = React44.useCallback(
        (nextIndex) => {
          setLocalActiveIndex(getNextIndex(nextIndex));
        },
        [getNextIndex]
      );
      const moveBackward = React44.useCallback(() => moveActiveIndex(-1), [moveActiveIndex]);
      const moveForward = React44.useCallback(() => moveActiveIndex(1), [moveActiveIndex]);
      return {
        activeIndex,
        moveActiveIndex,
        setActiveIndex,
...
var require_Group = __commonJS({
  "../../node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    __export2(Group_exports, {
      ...
      XGroup: () => XGroup,
      YGroup: () => YGroup,
      useGroupItem: () => useGroupItem2
    });
    module2.exports = __toCommonJS2(Group_exports);
    var import_jsx_runtime49 = require("react/jsx-runtime");
    var import_core56 = require("@tamagui/core-node");
    var import_create_context20 = require_cjs13();
    var import_stacks28 = require_cjs14();
    var import_use_controllable_state13 = require_cjs15();
    var import_react37 = __toESM2(require("react"));
    var import_react_native14 = require("react-native-web-lite");
    ...
    var GroupFrame = (0, import_core56.styled)(import_stacks28.ThemeableStack, {
      name: "GroupFrame",
      variants: {
        unstyled: {
          false: {
    ...
    function createGroup(verticalDefault) {
      return (0, import_core56.withStaticProperties)(
        (0, import_react37.forwardRef)((props, ref) => {
          const activeProps = (0, import_core56.useMediaPropsActive)(props);
          const {
            __scopeGroup,
            ...
            forceUseItem,
            ...restProps
          } = (0, import_core56.getExpandedShorthands)(activeProps);
          const vertical = axis === "vertical";
          const [itemChildrenCount, setItemChildrenCount] = (0, import_use_controllable_state13.useControllableState)({
            defaultProp: forceUseItem ? 1 : 0
          });
          const isUsingItems = true;
          const radius = borderRadius ?? (size2 ? (0, import_core56.getVariableValue)((0, import_core56.getTokens)().radius[size2]) - 1 : void 0);
          const hasRadius = radius !== void 0;
          const disablePassBorderRadius = disablePassBorderRadiusProp ?? !hasRadius;
          if (!isUsingItems)
            console.log("screw up!");
          const childrenArray = import_react37.Children.toArray(childrenProp);
          ...
          const onItemMount = import_react37.default.useCallback(
            () => setItemChildrenCount((prev) => prev + 1),
            []
          );
          const onItemUnmount = import_react37.default.useCallback(
            () => setItemChildrenCount((prev) => prev - 1),
            []
          );
    ...
    var GroupItem = /* @__PURE__ */ __name((props) => {
      ...
      const groupItemProps = useGroupItem2(
      ...
      if ((0, import_core56.isTamaguiElement)(children)) {
        return import_react37.default.cloneElement(children, groupItemProps);
      }
    ...
    var useGroupItem2 = /* @__PURE__ */ __name((childrenProps, __scopeGroup) => {
    ...
    var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
      const next = (0, import_core56.mergeProps)(child.props, props, false, (0, import_core56.getConfig)().shorthands)[0];
      return import_react37.default.cloneElement({ ...child, props: null }, next);
    ...
    function focusableInputHOC3(Component) {
      const component = Component.extractable(
        (0, import_react37.forwardRef)(
          (props, ref) => {
            const isInput = (0, import_web13.isTamaguiComponent)(Component) && Component.staticConfig.isInput;
            const inputValue = (0, import_react37.useRef)(props.value || props.defaultValue || "");
            const unregisterFocusable = (0, import_react37.useRef)();
            const inputRef = (0, import_react37.useCallback)(
              (input) => {
                var _a;
                if (!props.id)
                  return;
            ...
            const combinedRefs = (0, import_compose_refs16.composeRefs)(ref, inputRef);
            (0, import_react37.useEffect)(() => {
              return () => {
                var _a;
                (_a = unregisterFocusable.current) == null ? void 0 : _a.call(unregisterFocusable);
            ...
            const onChangeText = (0, import_web13.useEvent)((value) => {
              var _a;
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(Component, { ref: combinedRefs, ...finalProps });
          }
        )
      );
      return component;
...
var require_SizableText = __commonJS({
  "../../node_modules/@tamagui/text/dist/cjs/SizableText.js"(exports, module2) {
    ...
    var import_web13 = require("@tamagui/core-node");
    var SizableText2 = (0, import_web13.styled)(import_web13.Text, {
      name: "SizableText",
      fontFamily: "$body",
      variants: {
...
var require_Paragraph = __commonJS({
  "../../node_modules/@tamagui/text/dist/cjs/Paragraph.js"(exports, module2) {
    ...
    var Paragraph2 = (0, import_web13.styled)(import_SizableText2.SizableText, {
      name: "Paragraph",
      tag: "p",
      userSelect: "auto",
      color: "$color",
...
var require_Headings = __commonJS({
  "../../node_modules/@tamagui/text/dist/cjs/Headings.js"(exports, module2) {
    ...
    var Heading2 = (0, import_web13.styled)(import_Paragraph2.Paragraph, {
      tag: "span",
      name: "Heading",
    ...
    var H12 = (0, import_web13.styled)(Heading2, {
      name: "H1",
      tag: "h1",
      size: "$10"
    });
    var H22 = (0, import_web13.styled)(Heading2, {
      name: "H2",
      tag: "h2",
      size: "$9"
    });
    var H32 = (0, import_web13.styled)(Heading2, {
      name: "H3",
      tag: "h3",
      size: "$8"
    });
    var H42 = (0, import_web13.styled)(Heading2, {
      name: "H4",
      tag: "h4",
      size: "$7"
    });
    var H52 = (0, import_web13.styled)(Heading2, {
      name: "H5",
      tag: "h5",
      size: "$6"
    });
    var H62 = (0, import_web13.styled)(Heading2, {
      name: "H6",
      tag: "h6",
      size: "$5"
    });
...
var require_wrapChildrenInText = __commonJS({
  "../../node_modules/@tamagui/text/dist/cjs/wrapChildrenInText.js"(exports, module2) {
    ...
    function wrapChildrenInText2(TextComponent, propsIn, extraProps) {
      ...
      const allChildren = import_react37.default.Children.toArray(children);
      const nextChildren = [];
      ...
      function concatStringChildren() {
        ...
        nextChildren[index3] = /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(TextComponent, { ...props, ...textProps, children: childrenStrings }, index3);
      }
...
var require_ListItem = __commonJS({
  "../../node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_jsx_runtime49 = require("react/jsx-runtime");
    var import_core56 = require("@tamagui/core-node");
    var import_font_size3 = require_cjs9();
    var import_helpers_tamagui3 = require_cjs12();
    var import_stacks28 = require_cjs14();
    var import_text8 = require_cjs18();
    var import_react37 = require("react");
    var NAME3 = "ListItem";
    var ListItemFrame = (0, import_core56.styled)(import_stacks28.ThemeableStack, {
      name: NAME3,
      tag: "li",
      variants: {
        unstyled: {
    ...
    var ListItemText = (0, import_core56.styled)(import_text8.SizableText, {
      name: "ListItemText",
      variants: {
        unstyled: {
          false: {
    ...
    var ListItemSubtitle = (0, import_core56.styled)(ListItemText, {
    ...
    var ListItemTitle = (0, import_core56.styled)(ListItemText, {
      name: "ListItemTitle"
    });
    var useListItem = /* @__PURE__ */ __name((props, {
      ...
      const mediaActiveProps = (0, import_core56.useMediaPropsActive)(props);
      const size2 = mediaActiveProps.size || "$true";
      const subtitleSize = `$${+String(size2).replace("$", "") - 1}`;
      const iconSize = (0, import_font_size3.getFontSize)(size2) * scaleIcon;
      const getThemedIcon = (0, import_helpers_tamagui3.useGetThemedIcon)({ size: iconSize, color });
      const [themedIcon, themedIconAfter] = [icon, iconAfter].map(getThemedIcon);
      const spaceSize = (0, import_core56.getVariableValue)((0, import_core56.getTokens)().space[mediaActiveProps.space] ?? iconSize) * scaleSpace;
      const contents = (0, import_text8.wrapChildrenInText)(Text6, mediaActiveProps);
      return {
        props: {
          fontFamily,
          ...rest,
          children: /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_core56.Spacer, { size: spaceSize })
            ] }) : null,
            title || subTitle ? /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(import_stacks28.YStack, { flex: 1, children: [
              noTextWrap === "all" ? title : /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(Title, { size: size2, children: title }),
              subTitle ? /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_jsx_runtime49.Fragment, { children: typeof subTitle === "string" && noTextWrap !== "all" ? /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(Subtitle, { size: subtitleSize, children: subTitle }) : subTitle }) : null,
              contents
            ] }) : contents,
    ...
    var ListItemComponent = (0, import_react37.forwardRef)((props, ref) => {
    ...
    var ListItem2 = (0, import_core56.withStaticProperties)(
      ListItemFrame.extractable(
        (0, import_core56.themeable)(ListItemComponent, { componentName: NAME3 }),
...
__export(esm_exports, {
  ...
  Text: () => import_core55.Text,
  TextAncestorContext: () => import_core55.TextAncestorContext,
  TextArea: () => TextArea,
  ...
  addTheme: () => import_core55.addTheme,
  ...
  getAnimationDriver: () => import_core55.getAnimationDriver,
  ...
  updateTheme: () => import_core55.updateTheme,
  ...
  useSafeRef: () => import_core55.useSafeRef,
...
function useControllableState({
  ...
  const transitionFn = transition ? import_react10.startTransition : emptyCallbackFn;
...
var useKeyboardVisible = /* @__PURE__ */ __name(() => {
  const [isKeyboardVisible, setKeyboardVisible] = (0, import_react11.useState)(false);
...
var ScrollView = (0, import_web2.styled)(
...
var SheetScrollView = (0, import_react12.forwardRef)(
  ({ __scopeSheet, children, ...props }, ref) => {
    ...
    const [percentToPadBottom, setPercentToPadBottom] = (0, import_react12.useState)(0);
    const next = 100 - percentOpened;
    if (open && next !== percentToPadBottom) {
      setPercentToPadBottom(next);
    }
    const state = (0, import_react12.useRef)({
      lastPageY: 0,
      dragAt: 0,
      dys: [],
      isScrolling: false,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
      ScrollView,
      {
        ref: (0, import_core10.composeRefs)(scrollRef, ref),
        flex: 1,
        ...
        ...props,
        children: [
          (0, import_react12.useMemo)(() => children, [children]),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_core10.Stack, { height: percentToPadBottom / 100 * frameSize, width: 0 })
        ]
      }
    );
  }
...
// ../../node_modules/@tamagui/sheet/dist/esm/Sheet.js
var SheetHandleFrame = (0, import_core11.styled)(XStack, {
...
var SheetOverlayFrame = (0, import_core11.styled)(YStack, {
  ...
  ({ __scopeSheet, ...props }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      SheetOverlayFrame,
      {
        ...
        ...props,
        onPress: (0, import_core11.mergeEvent)(
          props.onPress,
...
var selectionStyleSheet = import_core11.isClient ? document.createElement("style") : null;
if (selectionStyleSheet) {
  document.head.appendChild(selectionStyleSheet);
}
var SheetFrameFrame = (0, import_core11.styled)(YStack, {
  name: SHEET_NAME,
  flex: 1,
  backgroundColor: "$background",
  borderTopLeftRadius: "$true",
...
var SheetFrame = SheetFrameFrame.extractable(
  (0, import_react13.forwardRef)(
    ({ __scopeSheet, ...props }, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SheetFrameFrame, { ref: composedContentRef, ...props });
    }
  )
);
var HIDDEN_SIZE = 1e4;
...
var Sheet = (0, import_core11.withStaticProperties)(
  (0, import_react13.forwardRef)(/* @__PURE__ */ __name(function Sheet2(props, ref) {
    const hydrated = (0, import_core11.useDidFinishSSR)();
    const { isShowingNonSheet } = useSheetContoller();
    if (isShowingNonSheet || !hydrated) {
      return null;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SheetImplementation, { ref, ...props });
  }, "Sheet2")),
  sheetComponents
);
var SheetImplementation = (0, import_core11.themeable)(
  (0, import_react13.forwardRef)(/* @__PURE__ */ __name(function SheetImplementation2(props, ref) {
    ...
    const driver = (0, import_core11.getAnimationDriver)();
    if (!driver) {
    ...
    const animateTo = (0, import_core11.useEvent)((position2) => {
    ...
    const shouldHideParentSheet = !import_core11.isWeb && modal && isShowingInnerSheet;
    ...
    const handleLayout = (0, import_react13.useCallback)((e) => {
      ...
      if (import_core11.isWeb && import_core11.isTouchable && !open) {
        next += 100;
      }
      if (!next)
        return;
    ...
    const contents = /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ParentSheetContext.Provider, { value: nextParentContext, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      SheetProvider,
      {
        modal,
        contentRef,
    ...
    const adaptContext = (0, import_react13.useContext)(AdaptParentContext);
    if (modal) {
      const modalContents = /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Portal, { zIndex, ...portalProps, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_core11.Theme, { forceClassName: true, name: themeName, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(AdaptParentContext.Provider, { value: adaptContext, children: contents }) }) });
...
var SheetController = /* @__PURE__ */ __name(({
  ...
  const onOpenChange = (0, import_core11.useEvent)(onOpenChangeProp);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SheetControllerContext.Provider, { value: memoValue, children });
}, "SheetController");
...
function wrapChildrenInText(TextComponent, propsIn, extraProps) {
  ...
  const allChildren = import_react14.default.Children.toArray(children);
  const nextChildren = [];
  let lastIsString = false;
  const props = {
    ...extraProps
  ...
  function concatStringChildren() {
    ...
    const index3 = nextChildren.length - 1;
    const childrenStrings = nextChildren[index3];
    nextChildren[index3] = /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(TextComponent, { ...props, ...textProps, children: childrenStrings }, index3);
  }
  __name(concatStringChildren, "concatStringChildren");
  for (const child of allChildren) {
    const last = nextChildren[nextChildren.length - 1];
...
var DialogPortalItem = /* @__PURE__ */ __name((props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(PortalItem, { hostName: props.hostName, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogPortalItemContent, { ...props, themeName, context }) });
}, "DialogPortalItem");
function DialogPortalItemContent(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogProvider, { scope: __scopeDialog, ...context, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core12.Theme, { name: themeName, children: childrenSpaced }) });
}
...
var DialogPortal = /* @__PURE__ */ __name((props) => {
  ...
  if (context.modal) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogPortalItem, { __scopeDialog, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(PortalProvider2, { scope: __scopeDialog, forceMount, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogPortalFrame, { pointerEvents: isShowing ? "auto" : "none", ...frameProps, children: contents }) }) });
  }
  return contents;
}, "DialogPortal");
...
var DialogOverlay = React11.forwardRef(
  ({ __scopeDialog, ...props }, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogOverlayImpl, { context, ...overlayProps, ref: forwardedRef });
  }
);
...
var DialogContent = DialogContentFrame.extractable(
  React11.forwardRef(
    ({ __scopeDialog, ...props }, forwardedRef) => {
      ...
      const contents = context.modal ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogContentModal, { context, ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogContentNonModal, { context, ...contentProps, ref: forwardedRef });
...
var DialogContentImpl = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    if (showSheet) {
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogPortalItem, { hostName: getSheetContentsName(context), children: contentProps.children });
    }
    if (!import_core12.isWeb) {
      return contents;
    }
...
var DialogTitle = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogTitleFrame, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
  ...
  React11.forwardRef(/* @__PURE__ */ __name(function Dialog2(props, ref) {
    ...
    const { when, AdaptProvider } = useAdaptParent({
      Contents: React11.useCallback(
        (props2) => {
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(PortalHost, { forwardProps: props2, name: sheetContentsName });
        },
        [sheetContentsName]
      )
    });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(AdaptProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogProvider, { ...context, sheetBreakpoint: when, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogSheetController, { onOpenChange: setOpen, __scopeDialog, children }) }) });
  }, "Dialog2")),
  {
...
var DialogSheetContents = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(PortalHost, { forwardProps: props, name });
}, "DialogSheetContents");
...
var NativeAlertDialogTriggerFrame = (0, import_core13.styled)(YStack, {
  name: "DialogTrigger"
});
var AlertDialogTrigger = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogTrigger, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var AlertDialogPortal = /* @__PURE__ */ __name((props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogPortal, { ...dialogScope, ...portalProps });
}, "AlertDialogPortal");
...
var AlertDialogOverlay = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogOverlay, { ...dialogScope, ...overlayProps, ref: forwardedRef });
  }
);
      ...
      DialogWarningProvider,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core13.Slottable, { children }),
...
var AlertDialogTitle = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogTitle, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }
);
...
var AlertDialogDescription = React12.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogDescription, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
});
...
var AlertDialogAction = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogClose, { ...dialogScope, ...actionProps, ref: forwardedRef });
  }
);
...
var AlertDialogCancel = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogClose, { ...dialogScope, ...cancelProps, ref });
  }
);
...
var AlertDialogInner = /* @__PURE__ */ __name((props) => {
  ...
  if (process.env.TAMAGUI_TARGET === "native") {
    ...
    forEachChildDeep(React12.Children.toArray(props.children), (child) => {
      if (!React12.isValidElement(child))
        return false;
      const name = (0, import_core13.isTamaguiElement)(child) ? child.type.staticConfig.componentName : child.type["displayName"];
      switch (name) {
        case TRIGGER_NAME2: {
    ...
    (0, import_core13.useIsomorphicLayoutEffect)(() => {
      ...
      if (title || description) {
        import_react_native5.Alert.alert(title, description, buttons);
      }
    }, [native, open]);
    if (native) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Dialog, { ...dialogScope, ...alertDialogProps, modal: true });
}, "AlertDialogInner");
...
var AvatarImage = React13.forwardRef(
  (props, forwardedRef) => {
    ...
    const extras = (0, import_core14.getVariantExtras)(props);
    const shapeSize = (0, import_core14.getVariableValue)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(YStack, { fullscreen: true, zIndex: 1, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      import_image.Image,
      {
        fullscreen: true,
...
var AvatarFallbackFrame = (0, import_core14.styled)(YStack, {
  name: FALLBACK_NAME,
  position: "absolute",
  fullscreen: true,
  zIndex: 0
...
var AvatarFallback = AvatarFallbackFrame.extractable(
  React13.forwardRef(
    (props, forwardedRef) => {
      ...
      return canRender && context.imageLoadingStatus !== "loaded" ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(AvatarFallbackFrame, { ...fallbackProps, ref: forwardedRef }) : null;
    }
  )
);
AvatarFallback.displayName = FALLBACK_NAME;
var AvatarFrame = (0, import_core14.styled)(Square, {
  name: AVATAR_NAME,
  position: "relative",
  overflow: "hidden"
});
var Avatar = (0, import_core14.withStaticProperties)(
  React13.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        AvatarProvider,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(AvatarFrame, { size: size2, ...avatarProps, ref: forwardedRef })
        }
      );
    }
  ),
...
var ButtonComponent = (0, import_react15.forwardRef)(/* @__PURE__ */ __name(function Button(props, ref) {
  const {
    props: { unstyled, ...buttonProps }
  } = useButton(props);
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ButtonFrame, { defaultStyle: !unstyled, ...buttonProps, ref });
}, "Button"));
...
var Button2 = ButtonFrame.extractable(
  (0, import_web8.themeable)(ButtonComponent, ButtonFrame.staticConfig),
  buttonStaticConfig
);
function useButton(propsIn, { Text: Text6 = ButtonText } = { Text: ButtonText }) {
  ...
  const isNested = import_web8.isRSC ? false : (0, import_react15.useContext)(import_web8.ButtonNestingContext);
  const propsActive = (0, import_web8.useMediaPropsActive)(propsIn);
  ...
  const props = {
    ...
    tag,
    ...rest,
    children: import_web8.isRSC ? inner2 : /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_web8.ButtonNestingContext.Provider, { value: true, children: inner2 })
  };
  return {
    spaceSize,
    isNested,
...
var Card = (0, import_web9.withStaticProperties)(
  CardFrame.extractable(
    (0, import_react16.forwardRef)(
      ({ size: size2, __scopeCard, children, ...props }, ref) => {
        return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(CardFrame, { ref, ...props, children: import_react16.default.Children.map(children, (child) => {
...
// ../../node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports, __toESM(require_cjs9(), 1), module.exports);
...
var FORM_NAME = "Form";
var FormFrame = (0, import_core15.styled)(import_core15.Stack, {
  name: FORM_NAME,
  tag: "form"
});
...
var FormTriggerFrame = (0, import_core15.styled)(import_core15.Stack, {
  name: TRIGGER_NAME3
});
    ...
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
        FormTriggerFrame,
        {
          tag: "button",
          ...triggerProps,
          children: triggerProps.asChild ? (0, import_react17.cloneElement)(children, { disabled: triggerProps.disabled }) : children,
          ref: forwardedRef,
          onPress: (0, import_core15.composeEventHandlers)(props.onPress, context.onSubmit)
        }
      );
    }
  )
...
function FormComponent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(FormProvider, { scope: props.__scopeForm, onSubmit, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(FormFrame, { ...props, onSubmit: (e) => e.preventDefault() }) });
}
__name(FormComponent, "FormComponent");
var Form = (0, import_core15.withStaticProperties)(FormFrame.extractable(FormComponent), {
  Trigger: FormTrigger
});

// ../../node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports, __toESM(require_cjs16(), 1), module.exports);
__reExport(esm_exports, __toESM(require_cjs12(), 1), module.exports);
__reExport(esm_exports, __toESM(require_cjs8(), 1), module.exports);
...
var NAME2 = "Label";
var [LabelProvider, useLabelContextImpl] = createContext3(NAME2, {
  id: void 0,
...
var LabelComponent = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs(forwardedRef, ref);
    const backupId = (0, import_web10.useId)();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(LabelProvider, { id, controlRef, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      LabelFrame,
      {
        role: "heading",
        id,
...
// ../../node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports, __toESM(require_cjs19(), 1), module.exports);
...
function useFloating(options) {
  ...
  const [reference, _setReference] = React16.useState(null);
  const [floating, _setFloating] = React16.useState(null);
...
var FloatingOverrideContext = (0, import_react19.createContext)(null);
var useFloating2 = /* @__PURE__ */ __name((props) => {
  var _a;
  const context = (0, import_react19.useContext)(FloatingOverrideContext);
...
var PopperAnchor = YStack.extractable(
  React17.forwardRef(/* @__PURE__ */ __name(function PopperAnchor2(props, forwardedRef) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(YStack, { ...getReferenceProps ? getReferenceProps(stackProps) : stackProps });
  }, "PopperAnchor2"))
);
var CONTENT_NAME3 = "PopperContent";
var PopperContentFrame = (0, import_core18.styled)(ThemeableStack, {
  name: "PopperContent",
  variants: {
    unstyled: {
      false: {
...
var PopperArrowFrame = (0, import_core18.styled)(YStack, {
  name: "PopperArrow",
  variants: {
    unstyled: {
      false: {
...
var PopperArrowOuterFrame = (0, import_core18.styled)(YStack, {
...
var PopperArrow = PopperArrowFrame.extractable(
  React17.forwardRef(/* @__PURE__ */ __name(function PopperArrow2(props, forwardedRef) {
    ...
    const sizeValResolved = (0, import_core18.getVariableValue)((0, import_get_size.stepTokenUpOrDown)("space", sizeVal, -2, [2]));
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(PopperArrowOuterFrame, { ref: refs, ...arrowStyle, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
      PopperArrowFrame,
      {
        width: size2,
        height: size2,
...
var import_aria_hidden2 = __toESM(require_es5(), 1);
var import_tabbable = __toESM(require_dist4(), 1);
...
var useHover = /* @__PURE__ */ __name(function(context, _temp) {
  ...
  const closeWithDelay = React18.useCallback(function(runElseBranch) {
...
var FocusGuard = /* @__PURE__ */ React18.forwardRef(/* @__PURE__ */ __name(function FocusGuard2(props, ref) {
  const onFocus = useEvent4(props.onFocus);
...
var useFloatingPortalNode = /* @__PURE__ */ __name(function(_temp) {
  ...
  const [portalEl, setPortalEl] = React18.useState(null);
...
var FloatingPortal = /* @__PURE__ */ __name((_ref) => {
  ...
  return /* @__PURE__ */ React18.createElement(PortalContext.Provider, {
    ...
    style: HIDDEN_STYLES
  }), root ? /* @__PURE__ */ (0, import_react_dom2.createPortal)(children, root) : portalNode ? /* @__PURE__ */ (0, import_react_dom2.createPortal)(children, portalNode) : null, shouldRenderGuards && portalNode && /* @__PURE__ */ React18.createElement(FocusGuard, {
    "data-type": "outside",
    ref: afterOutsideRef,
    onFocus: (event) => {
      if (isOutsideEvent(event, portalNode)) {
...
function FloatingFocusManager(_ref) {
  ...
  const tree = useFloatingTree();
  const portalContext = usePortalContext2();
  const [tabbableContentLength, setTabbableContentLength] = React18.useState(null);
  ...
  }), isTypeableCombobox ? null : renderDismissButton("start"), /* @__PURE__ */ React18.cloneElement(children, tabbableContentLength === 0 || order.includes("floating") ? {
    tabIndex: 0
  } : {}), renderDismissButton("end"), shouldRenderGuards && /* @__PURE__ */ React18.createElement(FocusGuard, {
    "data-type": "inside",
...
var useDismiss = /* @__PURE__ */ __name(function(_ref, _temp) {
  ...
  const outsidePressFn = useEvent4(typeof unstable_outsidePress === "function" ? unstable_outsidePress : () => false);
...
var useListNavigation = /* @__PURE__ */ __name(function(_ref, _temp2) {
  ...
  const parentId = useFloatingParentNodeId();
  const tree = useFloatingTree();
  const onNavigate = useEvent4(unstable_onNavigate);
  ...
  const focusItem = React18.useCallback(function(listRef2, indexRef2, forceScrollIntoView) {
...
var useTypeahead = /* @__PURE__ */ __name(function(_ref, _temp) {
  ...
  const prevIndexRef = React18.useRef((_ref2 = selectedIndex != null ? selectedIndex : activeIndex) != null ? _ref2 : -1);
  const matchIndexRef = React18.useRef(null);
  const onMatch = useEvent4(unstable_onMatch);
...
var useInnerOffset = /* @__PURE__ */ __name((_ref, _ref2) => {
  ...
  const onChange = useEvent4(unstable_onChange);
...
function useFloating3(options) {
  ...
  const onOpenChange = useEvent4(unstable_onOpenChange);
...
var PopoverAnchor = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopperAnchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
PopoverAnchor.displayName = ANCHOR_NAME2;
var TRIGGER_NAME4 = "PopoverTrigger";
var PopoverTrigger = React19.forwardRef((props, forwardedRef) => {
  ...
  const trigger = /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
    YStack,
    {
      ...
      ...triggerProps,
      ref: composedTriggerRef,
      onPress: (0, import_core19.composeEventHandlers)(props.onPress, context.onOpenToggle)
    }
  );
  return context.hasCustomAnchor ? trigger : /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopperAnchor, { asChild: true, ...popperScope, children: trigger });
});
...
var PopoverContent = PopperContentFrame.extractable(
  React19.forwardRef(
    /* @__PURE__ */ __name(function PopoverContent2(props, forwardedRef) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopoverContentPortal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        PopoverContentImpl,
        {
          ...contentImplProps,
          disableRemoveScroll,
          ...
          disableOutsidePointerEvents: true,
          onCloseAutoFocus: (0, import_core19.composeEventHandlers)(props.onCloseAutoFocus, (event) => {
            var _a;
            event.preventDefault();
            if (!isRightClickOutsideRef.current)
              (_a = context.triggerRef.current) == null ? void 0 : _a.focus();
          }),
          onPointerDownOutside: (0, import_core19.composeEventHandlers)(
            props.onPointerDownOutside,
            (event) => {
              const originalEvent = event.detail.originalEvent;
              const ctrlLeftClick = originalEvent.button === 0 && originalEvent.ctrlKey === true;
          ...
          onFocusOutside: (0, import_core19.composeEventHandlers)(
            props.onFocusOutside,
            (event) => event.preventDefault(),
            { checkDefaultPrevented: false }
          )
...
function PopoverContentPortal(props) {
  const themeName = (0, import_core19.useThemeName)();
  const context = usePopoverInternalContext(CONTENT_NAME4, props.__scopePopover);
  let contents = props.children;
  if (import_react_native7.Platform.OS === "android") {
    const popperContext = usePopperContext(CONTENT_NAME4, context.popperScope);
    contents = /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopperProvider, { ...popperContext, scope: context.popperScope, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopoverProviderInternal, { scope: props.__scopePopover, ...context, children: props.children }) });
  }
  const zIndex = props.zIndex ?? 1e3;
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Portal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_core19.Theme, { forceClassName: true, name: themeName, children: [
    !!context.open && !context.breakpointActive && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      YStack,
      {
        fullscreen: true,
        onPress: (0, import_core19.composeEventHandlers)(props.onPress, context.onOpenToggle)
    ...
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_core19.Stack, { zIndex: zIndex + 1, children: contents })
  ] }) });
}
...
var PopoverContentImpl = React19.forwardRef((props, forwardedRef) => {
  ...
  if (context.breakpointActive) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PortalItem, { hostName: `${context.scopeKey}PopoverContents`, children: childrenWithoutScrollView });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AnimatePresence, { children: !!context.open && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
    PopperContent,
    {
      "data-state": getState2(context.open),
      id: context.contentId,
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        RemoveScroll,
        {
          ...
          children: trapFocus === false ? children : /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
            import_focus_scope2.FocusScope,
            {
              ...
              onMountAutoFocus: onOpenAutoFocus,
              onUnmountAutoFocus: onCloseAutoFocus,
              children: import_core19.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { style: { display: "contents" }, children }) : children
            }
          )
        }
      )
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      YStack,
      {
        ...closeProps,
        ref: forwardedRef,
        onPress: (0, import_core19.composeEventHandlers)(
          props.onPress,
          () => context.onOpenChange(false)
        )
      }
...
var PopoverArrow = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopoverScope(__scopePopover);
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopperArrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
PopoverArrow.displayName = ARROW_NAME2;
var PopoverScrollView = React19.forwardRef((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react_native7.ScrollView, { ref, ...props });
});
var Popover = (0, import_core19.withStaticProperties)(
  /* @__PURE__ */ __name(function Popover2(props) {
    ...
    const internalId = (0, import_core19.useId)();
    const id = __scopePopover ? Object.keys(__scopePopover)[0] : internalId;
    const { when, AdaptProvider } = useAdaptParent({
      Contents: React19.useCallback(() => {
        return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PortalHost, { name: `${id}PopoverContents` });
      }, [])
    });
    ...
    const popoverContext = {
      ...
      sheetBreakpoint,
      contentId: (0, import_core19.useId)(),
      triggerRef,
      open,
      breakpointActive,
      onOpenChange: setOpen,
      onOpenToggle: (0, import_core19.useEvent)(() => {
    ...
    const contents = /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Popper, { ...popperScope, stayInFrame: true, ...restProps, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopoverProviderInternal, { ...popoverContext, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopoverSheetController, { onOpenChange: setOpen, __scopePopover, children }) }) });
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AdaptProvider, { children: import_core19.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(FloatingOverrideContext.Provider, { value: floatingContext, children: contents }) : contents });
  }, "Popover2"),
  {
...
var PopoverSheetController = /* @__PURE__ */ __name((props) => {
  ...
  const getShowSheet = (0, import_core19.useGet)(showSheet);
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
    SheetController,
    {
      onOpenChange: (val) => {
...
var useSheetBreakpointActive2 = /* @__PURE__ */ __name((breakpoint) => {
  const media = (0, import_core19.useMedia)();
...
var ProgressIndicatorFrame = (0, import_core20.styled)(ThemeableStack, {
  name: INDICATOR_NAME,
  height: "100%",
  width: "100%",
  backgrounded: true
...
var DEFAULT_MAX = 100;
var ProgressFrame = (0, import_core20.styled)(ThemeableStack, {
  name: PROGRESS_NAME,
  borderRadius: 1e5,
  overflow: "hidden",
  backgrounded: true,
  variants: {
    size: {
      "...size": (val) => {
        const size2 = Math.round((0, import_core20.getVariableValue)((0, import_get_size2.getSize)(val)) * 0.25);
        return {
          height: size2,
          minWidth: (0, import_core20.getVariableValue)(size2) * 20,
          width: "100%"
        };
      }
    }
...
var Progress = (0, import_core20.withStaticProperties)(
  ProgressFrame.extractable(
    React20.forwardRef(
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max3, width, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
          ProgressFrame,
          {
            size: size2,
            "aria-valuemax": max3,
...
var getState3 = /* @__PURE__ */ __name((checked) => {
  return checked ? "checked" : "unchecked";
}, "getState");
var RADIO_GROUP_INDICATOR_NAME = "RadioGroupIndicator";
var RadioIndicatorFrame = (0, import_core21.styled)(ThemeableStack, {
...
var RadioGroupItemFrame = (0, import_core21.styled)(ThemeableStack, {
    ...
    size: {
      "...size": (value, { props }) => {
        const size2 = Math.floor(
          (0, import_core21.getVariableValue)((0, import_get_size3.getSize)(value)) * (props["scaleSize"] ?? 0.5)
        );
        return {
          width: size2,
          height: size2
...
var RadioGroupItem = RadioGroupItemFrame.extractable(
  React21.forwardRef(
    (props, forwardedRef) => {
      ...
      const composedRefs = (0, import_core21.useComposedRefs)(forwardedRef, (node) => setButton(node), ref);
      const isArrowKeyPressedRef = React21.useRef(false);
      const isFormControl = import_core21.isWeb ? button ? Boolean(button.closest("form")) : true : false;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(RadioGroupItemProvider, { checked, scope: __scopeRadioGroup, children: import_core21.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
        BubbleInput,
        {
          control: button,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
          RadioGroupItemFrame,
          {
            ...
            ...itemProps,
            onPress: (0, import_core21.composeEventHandlers)(props.onPress, (event) => {
              if (!checked) {
                onChange == null ? void 0 : onChange(value);
              }
              if (isFormControl) {
            ...
            ...import_core21.isWeb && {
              onKeyDown: (0, import_core21.composeEventHandlers)(
                props.onKeyDown,
                (event) => {
                  if (event.key === "Enter")
                    event.preventDefault();
              ...
              onFocus: (0, import_core21.composeEventHandlers)(itemProps.onFocus, () => {
                var _a;
...
var RadioGroupFrame = (0, import_core21.styled)(ThemeableStack, {
...
var RadioGroup = (0, import_core21.withStaticProperties)(
...
var Separator = (0, import_core22.styled)(import_core22.Stack, {
  name: "Separator",
  borderColor: "$borderColor",
  flexShrink: 0,
  borderWidth: 0,
  ...
  variants: {
    vertical: {
      true: {
        y: 0,
        x: -0.5,
        height: import_core22.isWeb ? "initial" : "auto",
        maxHeight: import_core22.isWeb ? "initial" : "auto",
        width: 0,
        maxWidth: 0,
        borderBottomWidth: 0,
        borderRightWidth: 1
...
var ForwardSelectContext = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(SelectProvider, { isInSheet: true, scope: props.__scopeSelect, ...props.context, children: props.children });
...
var useSelectBreakpointActive = /* @__PURE__ */ __name((sheetBreakpoint) => {
  const media = (0, import_core23.useMedia)();
  if (!sheetBreakpoint)
    return false;
...
var SelectContent = /* @__PURE__ */ __name(({
  ...
  const themeName = (0, import_core24.useThemeName)();
  const showSheet = useShowSelectSheet(context);
  const contents = /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_core24.Theme, { forceClassName: true, name: themeName, children });
  const touch = (0, import_core24.useIsTouchDevice)();
  if (showSheet) {
    if (!context.open) {
      return null;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_jsx_runtime24.Fragment, { children: contents });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(FloatingPortal, { children: context.open ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(FloatingOverlay, { style: { zIndex }, lockScroll: !touch, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_focus_scope3.FocusScope, { loop: true, trapped: true, ...focusScopeProps, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Dismissable, { children: contents }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: { display: "none" }, children: contents }) });
}, "SelectContent");
...
var SelectInlineImpl = /* @__PURE__ */ __name((props) => {
  ...
  const touch = (0, import_core25.useIsTouchDevice)();
  ...
  if (import_core25.isWeb && import_core25.isClient) {
    React22.useEffect(() => {
      if (!open)
        return;
  ...
  (0, import_core25.useIsomorphicLayoutEffect)(() => {
    if (open) {
...
var SelectScrollButtonImpl = React23.memo(
  React23.forwardRef(
    (props, forwardedRef) => {
      ...
      (0, import_core26.useIsomorphicLayoutEffect)(() => {
        return () => {
          cancelAnimationFrame(frameRef.current);
        };
      }, []);
...
var SelectViewportFrame = (0, import_core28.styled)(ThemeableStack, {
  name: VIEWPORT_NAME,
  backgroundColor: "$background",
  elevate: true,
  bordered: true,
...
var SelectViewport = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    if (breakpointActive || !import_core27.isWeb) {
      return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(PortalItem, { hostName: `${context.scopeKey}SheetContents`, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(ForwardSelectContext, { context, children }) });
    }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
      !disableScroll && /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "style",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(FloatingFocusManager, { context: context.floatingContext, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        SelectViewportFrame,
        {
          size: context.size,
          role: "presentation",
...
var SelectValueFrame = (0, import_core29.styled)(Paragraph, {
  name: VALUE_NAME,
  userSelect: "none"
});
...
var SelectIcon = (0, import_core29.styled)(XStack, {
  name: "SelectIcon",
  "aria-hidden": true,
  children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Paragraph, { children: "\u25BC" })
});
...
var SelectItem = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    const textId = (0, import_core29.useId)();
    const {
      selectedIndex,
      setSelectedIndex,
      listRef,
...
var SelectItemTextFrame = (0, import_core29.styled)(SizableText, {
  name: ITEM_TEXT_NAME,
  userSelect: "none"
});
...
var SelectItemIndicatorFrame = (0, import_core29.styled)(XStack, {
  name: ITEM_TEXT_NAME
});
var SelectItemIndicator = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SelectItemIndicatorFrame, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
SelectItemIndicator.displayName = ITEM_INDICATOR_NAME;
var GROUP_NAME = "SelectGroup";
var [SelectGroupContextProvider, useSelectGroupContext] = createSelectContext(GROUP_NAME);
var SelectGroupFrame = (0, import_core29.styled)(YStack, {
  name: GROUP_NAME,
  width: "100%"
});
var SelectGroup = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = (0, import_core29.useId)();
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId || "", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      SelectGroupFrame,
      {
        role: "group",
...
var SelectSeparator = (0, import_core29.styled)(Separator, {
...
var SelectSheetImpl = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_jsx_runtime28.Fragment, { children: props.children });
}, "SelectSheetImpl");
var Select = (0, import_core29.withStaticProperties)(
  (props) => {
    const {
      __scopeSelect,
      children,
    ...
    const id = (0, import_core29.useId)();
    const scopeKey = __scopeSelect ? Object.keys(__scopeSelect)[0] ?? id : id;
    const { when, AdaptProvider } = useAdaptParent({
      Contents: React25.useCallback(
        () => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(PortalHost, { name: `${scopeKey}SheetContents` }),
        [scopeKey]
      )
    });
    const sheetBreakpoint = when;
    const isSheet = useSelectBreakpointActive(sheetBreakpoint);
    const SelectImpl = isSheet || !import_core29.isWeb ? SelectSheetImpl : SelectInlineImpl;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(AdaptProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      SelectProvider,
      {
        dir,
        ...
        value,
        open,
        children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SelectSheetController, { onOpenChange: setOpen, __scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
          SelectImpl,
          {
            activeIndexRef,
            listContentRef,
...
function composeEventHandlers7(og, next, { checkDefaultPrevented = true } = {}) {
  if (!og || !next) {
    return next || og;
  }
  return /* @__PURE__ */ __name(function composedEventHandler(event) {
...
__name(composeEventHandlers7, "composeEventHandlers");
...
var DirectionalYStack = (0, import_core30.styled)(YStack, {
  variants: {
    orientation: {
      horizontal: {},
      vertical: {}
...
var SliderFrame = (0, import_core30.styled)(DirectionalYStack, {
  position: "relative",
  variants: {
    size: (val, extras) => {
      const orientation = extras.props.orientation;
      const size2 = Math.round((0, import_core30.getVariableValue)((0, import_get_size4.getSize)(val)) / 6);
...
var SliderTrackFrame = (0, import_core31.styled)(SliderFrame, {
  name: "SliderTrack",
  height: "100%",
  width: "100%",
  backgroundColor: "$background",
...
var SliderTrackActiveFrame = (0, import_core31.styled)(SliderFrame, {
...
var getThumbSize = /* @__PURE__ */ __name((val) => {
  const size2 = typeof val === "number" ? val : (0, import_get_size5.getSize)(val, -1);
  return {
    width: size2,
    height: size2,
    minWidth: size2,
...
var SliderThumbFrame = (0, import_core31.styled)(ThemeableStack, {
  name: "SliderThumb",
  position: "absolute",
  bordered: 2,
  borderWidth: 2,
  backgrounded: true,
  pressTheme: import_core31.isWeb,
  focusTheme: import_core31.isWeb,
  hoverTheme: import_core31.isWeb,
  variants: {
    size: {
      "...size": getThumbSize
    }
...
var SliderThumb = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const [size2, setSize] = React28.useState(() => {
      const estimatedSize = (0, import_core31.getVariableValue)(getThumbSize(sizeIn).width);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
      SliderThumbFrame,
      {
        ...
        onFocus: composeEventHandlers7(props.onFocus, () => {
...
var Slider = (0, import_core31.withStaticProperties)(
  React28.forwardRef((props, forwardedRef) => {
    const {
      name,
      min: min3 = 0,
      max: max3 = 100,
...
var getSwitchHeight = /* @__PURE__ */ __name((val) => Math.round((0, import_core32.getVariableValue)((0, import_get_size6.getSize)(val)) * 0.65), "getSwitchHeight");
...
var SwitchThumbFrame = (0, import_core32.styled)(ThemeableStack, {
  name: "SwitchThumb",
  variants: {
    unstyled: {
      false: {
    ...
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
        SwitchThumbFrame,
        {
          ...
          "data-disabled": disabled ? "" : void 0,
          ...thumbProps,
          x: checked ? (0, import_core32.getVariableValue)(getSwitchWidth(size2)) - (0, import_core32.getVariableValue)(getSwitchHeight(size2)) : 0,
          ref: forwardedRef
        }
      );
    }
...
var SwitchFrame = (0, import_core32.styled)(XStack, {
  name: SWITCH_NAME,
  tag: "button",
  variants: {
    unstyled: {
...
var Switch = (0, import_core32.withStaticProperties)(
  SwitchFrame.extractable(
    React29.forwardRef(
      (props, forwardedRef) => {
        ...
        const isFormControl = import_core32.isWeb ? button ? Boolean(button.closest("form")) : true : false;
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)(
          SwitchProvider,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
                SwitchFrame,
                {
                  ...
                  onPress: (event) => {
                    ...
                    if (import_core32.isWeb && isFormControl) {
                      hasConsumerStoppedPropagationRef.current = event.isPropagationStopped();
                      if (!hasConsumerStoppedPropagationRef.current)
                        event.stopPropagation();
                    }
              ...
              import_core32.isWeb && isFormControl && /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
                BubbleInput2,
                {
                  control: button,
                  bubbles: !hasConsumerStoppedPropagationRef.current,
...
var VisuallyHidden = (0, import_web11.styled)(import_web11.Stack, {
  position: "absolute",
  width: 1,
  height: 1,
  margin: -1,
...
function createCollection(name) {
  ...
  const CollectionSlot = import_react27.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(import_core33.Slot, { ref: composedRefs, children });
    }
  );
  ...
  const CollectionItemSlot = import_react27.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(import_core33.Slot, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
    }
  );
...
var ToastProvider = /* @__PURE__ */ __name((props) => {
  ...
  const id = providedId ?? (0, import_core34.useId)();
  const [viewport, setViewport] = React31.useState(null);
  const [toastCount, setToastCount] = React31.useState(0);
  const isFocusedToastEscapeKeyDownRef = React31.useRef(false);
  const isClosePausedRef = React31.useRef(false);
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(Collection.Provider, { scope: __scopeToast, children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
    ToastProviderProvider,
    {
      ...
      onToastAdd: React31.useCallback(() => {
        setToastCount((prevCount) => prevCount + 1);
      }, []),
      onToastRemove: React31.useCallback(() => {
        setToastCount((prevCount) => prevCount - 1);
      }, []),
...
// ../../node_modules/@tamagui/toast/dist/esm/ToastAnnounce.js
var ToastAnnounceExcludeFrame = (0, import_core35.styled)(import_core35.Stack, {
  name: "ToastAnnounceExclude"
});
var ToastAnnounceExclude = React32.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounce = /* @__PURE__ */ __name((props) => {
  ...
  return isAnnounced ? null : /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(Portal, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(import_core35.Text, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
function useNextFrame(callback = () => {
  ...
  const fn = (0, import_core35.useEvent)(callback);
...
var ToastViewportWrapperFrame = (0, import_core36.styled)(YStack, {
  ...
  left: 0,
  right: 0,
  position: import_core36.isWeb ? "fixed" : "absolute",
  maxWidth: "100%",
  tabIndex: 0,
  zIndex: 1e5
});
var ToastViewportFrame = (0, import_core36.styled)(YStack, {
  name: VIEWPORT_NAME2,
  pointerEvents: "box-none",
  position: import_core36.isWeb ? "fixed" : "absolute",
  maxWidth: "100%"
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)(
      ToastViewportWrapperFrame,
      {
        ...
        tabIndex: -1,
        children: [
          hasToasts && /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
            FocusProxy,
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(Collection.Slot, { scope: __scopeToast, children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(ToastViewportFrame, { ref: composedRefs, ...viewportProps, children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
            PortalHost,
            {
              render: (children) => /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(AnimatePresence, { exitBeforeEnter: !multipleToasts, children }),
              name: name ?? "default"
            }
          ) }) }),
          hasToasts && /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
...
// ../../node_modules/@tamagui/toast/dist/esm/ToastImpl.js
var ToastImplFrame = (0, import_core37.styled)(ThemeableStack, {
  name: "ToastImpl",
  variants: {
    backgrounded: {
      true: {
...
var ToastImpl = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    const handleClose = (0, import_core37.useEvent)(() => {
      var _a;
      if (!isPresent2) {
        return;
      }
    ...
    const handlePause = React34.useCallback(() => {
    ...
    const panResponder = React34.useMemo(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(import_jsx_runtime37.Fragment, { children: [
      announceTextContent && /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(PortalItem, { hostName: viewportName ?? "default", children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
        ToastInteractiveProvider,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
            Dismissable,
            {
              onEscapeKeyDown: (0, import_core37.composeEventHandlers)(onEscapeKeyDown, () => {
                if (!context.isFocusedToastEscapeKeyDownRef.current) {
                  handleClose();
                }
                context.isFocusedToastEscapeKeyDownRef.current = false;
              }),
              children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_core37.Theme, { forceClassName: true, name: themeName, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
                AnimatedView,
                {
                  ...panResponder == null ? void 0 : panResponder.panHandlers,
                  style: [{ margin: "auto" }, animatedStyles],
                  children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(Collection.ItemSlot, { scope: __scopeToast, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
                    ToastImplFrame,
                    {
                      role: "status",
                      "aria-live": "off",
...
var ToastTitleFrame = (0, import_core38.styled)(SizableText, {
  name: TITLE_NAME3,
  color: "$color",
  variants: {
    unstyled: {
...
var ToastTitle = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToastTitleFrame, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME3;
var DESCRIPTION_NAME3 = "ToastDescription";
var ToastDescriptionFrame = (0, import_core38.styled)(SizableText, {
...
var ToastDescription = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToastDescriptionFrame, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME3;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React35.forwardRef(
  (props, forwardedRef) => {
    const { altText, ...actionProps } = props;
    if (!altText)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.propTypes = {
  altText(props) {
    if (!props.altText) {
      return new Error(`Missing prop \`altText\` expected on \`${ACTION_NAME2}\``);
    }
    return null;
  }
};
...
var ToastCloseFrame = (0, import_core38.styled)(ThemeableStack, {
  name: CLOSE_NAME3,
  tag: "button"
});
var ToastClose = React35.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME3, __scopeToast);
    return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToastAnnounceExclude, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
      ToastCloseFrame,
      {
        accessibilityLabel: "Dialog Close",
        ...closeProps,
        ref: forwardedRef,
        onPress: (0, import_core38.composeEventHandlers)(props.onPress, interactiveContext.onClose)
      }
    ) });
  }
);
ToastClose.displayName = CLOSE_NAME3;
var ToastComponent = React35.forwardRef(
  ToastImplFrame.extractable((props, forwardedRef) => {
    ...
    const id = (0, import_core38.useId)();
    const onPause = (0, import_core38.useEvent)(props.onPause);
    const onResume = (0, import_core38.useEvent)(props.onResume);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
      ToastImpl,
      {
        ...
        onPause,
        onResume,
        onSwipeEnd: (0, import_core38.composeEventHandlers)(props.onSwipeEnd, (event) => {
          setOpen(false);
        })
      }
    );
...
var Toast = (0, import_core38.withStaticProperties)(
  (0, import_core38.themeable)(ToastComponent, ToastImplFrame.staticConfig),
  {
    Title: ToastTitle,
...
var createNativeToast = /* @__PURE__ */ __name((title, { message, notificationOptions }) => {
  ...
  if (Notification.permission === "denied")
    false;
  const showNotification = /* @__PURE__ */ __name(() => {
...
// ../../node_modules/@tamagui/toast/dist/esm/ToastImperative.js
var [createImperativeToastContext, createImperativeToastScope] = createContextScope("ImperativeToast");
var [ToastImperativeProviderProvider, useToastProviderContext2] = createImperativeToastContext("ToastImperativeProvider");
var useToast = /* @__PURE__ */ __name(() => {
  const context = useToastProviderContext2("useToast", void 0);
  return {
...
var ToastImperativeProvider = /* @__PURE__ */ __name(({
  ...
  const counterRef = (0, import_react28.useRef)(0);
  const [toast, setToast] = import_react28.default.useState(null);
  const [lastNativeToastRef, setLastNativeToastRef] = import_react28.default.useState(null);
  const showToast = import_react28.default.useCallback(
    (title, showToastOptions) => {
      const native = (showToastOptions == null ? void 0 : showToastOptions.native) ?? options.native;
      ...
      const isHandledNatively = native === true || import_core39.isWeb && isWebNative || !import_core39.isWeb && isMobileNative || import_react_native9.Platform.OS === "android" && isAndroidNative || import_react_native9.Platform.OS === "ios" && isIosNative;
  ...
  const hideToast = import_react28.default.useCallback(() => {
    ...
    RovingFocusProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(
        import_core40.Stack,
        {
          ...
          onBlur: (0, import_core40.composeEventHandlers)(props.onBlur, () => setIsTabbingBackOut(false))
        }
      )
    }
  );
...
var RovingFocusGroupItem = React37.forwardRef((props, forwardedRef) => {
  const {
    __scopeRovingFocusGroup,
    focusable = true,
    active = false,
  ...
  const autoId = (0, import_core41.useId)();
...
var RovingFocusGroup = (0, import_core40.withStaticProperties)(
  React37.forwardRef(
    (props, forwardedRef) => {
      return /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
    }
  ),
  {
...
var TabsTrigger = TabsTriggerFrame.extractable(
  React38.forwardRef(
    (props, forwardedRef) => {
      ...
      const [layout, setLayout] = React38.useState(null);
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_web12.Theme, { forceClassName: true, name: isSelected ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(
...
var Tabs = (0, import_web12.withStaticProperties)(
  React38.forwardRef(
    (props, forwardedRef) => {
      ...
      const [triggersCount, setTriggersCount] = React38.useState(0);
...
var TooltipContent = PopperContentFrame.extractable(
  React39.forwardRef(
    ({ __scopePopover, ...props }, ref) => {
      ...
      const padding = props.size || popper.size || (0, import_get_size7.stepTokenUpOrDown)("size", "$true", -2);
...
var TooltipArrow = React39.forwardRef((props, ref) => {
...
var TooltipGroup = /* @__PURE__ */ __name(({ children, delay }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(FloatingDelayGroup, { delay: React39.useMemo(() => delay, [JSON.stringify(delay)]), children });
}, "TooltipGroup");
var TooltipComponent = React39.forwardRef(/* @__PURE__ */ __name(function Tooltip(props, ref) {
  const {
    __scopePopover,
    children,
    delay: delayProp,
  ...
  const onOpenChange = (0, import_core42.useEvent)((open2) => {
    setOpen(open2);
    if (open2) {
      setCurrentId(id);
    }
  ...
  const useFloatingContext2 = React39.useCallback(useFloatingFn, [id, delay, open]);
  const onCustomAnchorAdd = React39.useCallback(() => setHasCustomAnchor(true), []);
  const onCustomAnchorRemove = React39.useCallback(() => setHasCustomAnchor(false), []);
  const contentId = (0, import_core42.useId)();
  const twoSmallerKey = (0, import_get_size7.stepTokenUpOrDown)("size", "$true", -2).key;
  const size2 = `$${twoSmallerKey}`;
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(FloatingOverrideContext.Provider, { value: useFloatingContext2, children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(Popper, { size: size2, ...popperScope, ...restProps, children: /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
...
function useDebounce(fn, wait, options = defaultOpts, mountArgs = []) {
  const dbEffect = (0, import_react31.useRef)(null);
...
function useDebounceValue(val, amt = 0) {
  const [state, setState] = (0, import_react31.useState)(val);
  (0, import_react31.useEffect)(() => {
    const tm = setTimeout(() => {
      setState((prev) => {
        if (prev === val)
...
function useForceUpdate2() {
  return isServerSide ? idFn3 : (0, import_react32.useReducer)((x) => x + 1, 0)[1];
}
__name(useForceUpdate2, "useForceUpdate");

// ../../node_modules/@tamagui/constants/dist/esm/index.mjs
var import_react33 = require("react");
var isWeb24 = process.env.TAMAGUI_TARGET === "web";
var isWindowDefined = typeof window !== "undefined";
var isServer = isWeb24 && !isWindowDefined;
var isClient4 = isWeb24 && isWindowDefined;
var isRSC2 = process.env.ENABLE_RSC;
var idFn4 = /* @__PURE__ */ __name(() => {
}, "idFn");
var useIsomorphicLayoutEffect13 = isRSC2 ? idFn4 : isServer ? import_react33.useEffect : import_react33.useLayoutEffect;
...
if (process.env.NODE_ENV === "development") {
  ...
  } else if (isClient4 && process.env.TAMAGUI_TARGET !== "web" && process.env.TAMAGUI_IGNORE_TARGET !== "1") {
    console.warn(
...
function useWindowDimensions2() {
  ...
  if (process.env.TAMAGUI_TARGET != "web")
    return current;
  const [state, setState] = (0, import_react34.useState)(initialValue);
  useIsomorphicLayoutEffect13(() => {
    setState(current);
...
var CheckboxIndicatorFrame = (0, import_core43.styled)(ThemeableStack, {
...
var CheckboxIndicator = CheckboxIndicatorFrame.extractable(
  React40.forwardRef(
    (props, forwardedRef) => {
      ...
      const theme = (0, import_core43.useTheme)();
      const getThemedIcon = (0, import_helpers_tamagui2.useGetThemedIcon)({ size: iconSize, color: theme.color });
      const childrens = React40.Children.toArray(childrenProp);
      const children = childrens.map((child) => {
        if (disablePassStyles || !React40.isValidElement(child)) {
          return child;
        }
      ...
      if (forceMount || isIndeterminate(context.state) || context.state === true)
        return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
          ...
          {
            "data-state": getState5(context.state),
            "data-disabled": context.disabled ? "" : void 0,
            pointerEvents: "none",
            ...indicatorProps,
            ref: forwardedRef,
...
var CheckboxFrame = (0, import_core43.styled)(ThemeableStack, {
  name: CHECKBOX_NAME,
  tag: "button",
  variants: {
    unstyled: {
    ...
    size: {
      "...size": (val, { tokens }) => {
        const radiusToken = (0, import_core43.getVariableValue)((0, import_get_size8.getSize)(val)) / 8;
        return {
          borderRadius: radiusToken
        };
      }
...
var Checkbox = (0, import_core43.withStaticProperties)(
  CheckboxFrame.extractable(
    React40.forwardRef(
      (props, forwardedRef) => {
        ...
        const composedRefs = (0, import_core43.useComposedRefs)(forwardedRef, (node) => setButton(node));
        const hasConsumerStoppedPropagationRef = React40.useRef(false);
        const propsActive = (0, import_core43.useMediaPropsActive)(props);
        const isFormControl = import_core43.isWeb ? button ? Boolean(button.closest("form")) : true : false;
        const [checked = false, setChecked] = useControllableState({
          prop: checkedProp,
          defaultProp: defaultChecked,
          onChange: onCheckedChange
        });
        const adjustedSize = (0, import_core43.getVariableValue)(
          (0, import_get_size8.stepTokenUpOrDown)("size", propsActive.size, sizeAdjust)
        );
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
          CheckboxProvider,
          {
            ...
            size: size2,
            scaleIcon,
            children: import_core43.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
              BubbleInput3,
              {
                control: button,
                bubbles: !hasConsumerStoppedPropagationRef.current,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
                CheckboxFrame,
                {
                  ...
                  ...import_core43.isWeb && {
                    type: "button",
                    value,
                    onKeyDown: (0, import_core43.composeEventHandlers)(
                      props.onKeyDown,
                      (event) => {
                        if (event.key === "Enter")
                          event.preventDefault();
                  ...
                  onPress: (0, import_core43.composeEventHandlers)(props.onPress, (event) => {
                    setChecked(
              ...
              import_core43.isWeb && isFormControl ? /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
                BubbleInput3,
                {
                  isHidden: true,
                  control: button,
...
var createTamagui = process.env.NODE_ENV !== "development" ? import_core44.createTamagui : (conf) => {
  ...
  const tamaguiConfig = (0, import_core44.createTamagui)(conf);
...
var TamaguiProvider = import_core45.isRSC ? import_core45.TamaguiProvider : ({ children, ...props }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(import_core45.TamaguiProvider, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(PortalProvider, { shouldAddRootHost: true, children }) });
};
...
var Anchor = AnchorFrame.extractable(
  (0, import_react35.forwardRef)(({ href, target, ...props }, ref) => {
...
function Grid({ children, columns, itemMinWidth = 200, gap }) {
  ...
  const childrenList = import_react36.default.Children.toArray(children);
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(XStack, { alignItems: "center", justifyContent: "center", flexWrap: "wrap", children: childrenList.map((child, i) => {
    if (!child) {
      return null;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime47.jsx)(
...
var inputSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  const paddingHorizontal = (0, import_get_size9.stepTokenUpOrDown)("space", val, -1, [2]);
  const fontStyle = (0, import_get_font_sized3.getFontSized)(val, extras);
  if (!import_core50.isWeb && fontStyle) {
...
var textAreaSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  const buttonStyles = (0, import_get_button_sized5.getButtonSized)(val, extras);
  const fontStyle = (0, import_get_font_sized3.getFontSized)(val, extras);
  const height = props.numberOfLines ? (props.numberOfLines || 1) * (0, import_core50.getVariableValue)(fontStyle.lineHeight) : "auto";
  const paddingVertical = (0, import_get_size9.stepTokenUpOrDown)("space", val, -2, [2]);
  const paddingHorizontal = (0, import_get_size9.stepTokenUpOrDown)("space", val, -1, [2]);
  return {
    ...buttonStyles,
    ...fontStyle,
...
// ../../node_modules/tamagui/dist/esm/views/Input.js
(0, import_core51.setupReactNative)({
...
var InputFrame = (0, import_core51.styled)(
...
var Input = (0, import_focusable5.focusableInputHOC)(InputFrame);

// ../../node_modules/tamagui/dist/esm/views/Layouts.js
var import_core52 = require("@tamagui/core-node");
var Section = (0, import_core52.styled)(import_core52.Stack, {
  name: "Section",
  tag: "section",
  flexDirection: "column",
  accessibilityRole: "summary"
});
var Article = (0, import_core52.styled)(import_core52.Stack, {
  name: "Article",
  tag: "article",
  flexDirection: "column"
});
var Main = (0, import_core52.styled)(import_core52.Stack, {
  name: "Main",
  tag: "main",
  flexDirection: "column"
});
var Header = (0, import_core52.styled)(import_core52.Stack, {
  name: "Header",
  tag: "header",
  accessibilityRole: "header",
  flexDirection: "column"
});
var Aside = (0, import_core52.styled)(import_core52.Stack, {
  name: "Aside",
  tag: "aside",
  flexDirection: "column"
});
var Footer = (0, import_core52.styled)(import_core52.Stack, {
  name: "Footer",
  tag: "footer",
  flexDirection: "column"
});
var Nav = (0, import_core52.styled)(import_core52.Stack, {
  name: "Nav",
  tag: "nav",
  flexDirection: "column"
});
...
var Spinner = YStack.extractable(
  (0, import_core53.themeable)(
    React42.forwardRef((props, ref) => {
      const { size: size2, color: colorProp, ...stackProps } = props;
      const theme = (0, import_core53.useTheme)();
      let color = colorProp;
      if (color && color[0] === "$") {
        color = (0, import_core53.variableToString)(theme[color]);
      }
      return /* @__PURE__ */ (0, import_jsx_runtime48.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime48.jsx)(import_react_native13.ActivityIndicator, { size: size2, color }) });
    }),
    {
...
var TextArea = (0, import_focusable6.focusableInputHOC)(TextAreaFrame);

// ../../node_modules/tamagui/dist/esm/index.mjs
var import_core55 = require("@tamagui/core-node");
